    ...
    async def authorize(
        ...
        *,
        ...
        if principal.is_technician:
            ...
            if obj.id in related_project_ids:
                return None
            raise HTTPException(status_code=403, detail="无权限访问此项目")

        # finance: 直接403
        if principal.is_finance:
            raise HTTPException(status_code=403, detail="财务角色无权访问项目")
        ...
        *,
        ...
        if principal.is_sales:
            ...
            if (
                ...
                return None
            raise HTTPException(status_code=403, detail="只能创建自己负责的项目")
